const instructions: {
    ...
    load: (opr: [string, string]) => {
        reg.value[opr[0]] = {
            val: memory.value.store[Number.parseInt(opr[1])].val as number,
            justChanged: true,
        };
        reg.value["pc"] = {
            val: (reg.value["pc"].val as number) + 1,
    ...
    loadr: (opr: [string, string]) => {
        reg.value[opr[0]] = {
            val: memory.value.store[reg.value[opr[1]].val as number].val as number,
            justChanged: true,
        };
        reg.value["pc"] = {
            val: (reg.value["pc"].val as number) + 1,
    ...
    store: (opr: [string, string]) => {
        memory.value.store[Number.parseInt(opr[0])] = {
            val: reg.value[opr[1]].val as number,
            justChanged: true,
        };
        reg.value["pc"] = {
            val: (reg.value["pc"].val as number) + 1,
    ...
    storer: (opr: [string, string]) => {
        memory.value.store[reg.value[opr[0]].val as number] = {
            val: reg.value[opr[1]].val as number,
            justChanged: true,
        };
        reg.value["pc"] = {
    ...
    ret: () => {
        reg.value["pc"] = {
            val: memory.value.store[reg.value["sp"].val as number].val as number,
            justChanged: true,
        };
        reg.value["sp"] = {
            val: (reg.value["sp"].val as number) - 1,
    ...
    push: (opr: [string, string]) => {
        ...
        memory.value.store[reg.value["sp"].val as number] = {
            val: reg.value[opr[0]].val as number,
            justChanged: true,
        };
        reg.value["pc"] = {
            val: (reg.value["pc"].val as number) + 1,
